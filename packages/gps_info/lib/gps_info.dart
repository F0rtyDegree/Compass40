...
class GpsInfo {
  static const EventChannel _gpsDataChannel =
      EventChannel('com.example.gps_info/gps_data_stream');

  Stream<GpsData> getGpsDataStream([int? interval]) {
    return _gpsDataChannel
        .receiveBroadcastStream(interval)
        .map<GpsData>((dynamic data) => GpsData.fromMap(data as Map<dynamic, dynamic>));
  }
}
